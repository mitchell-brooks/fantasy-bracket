# ABOUTME: HTML parsing and data extraction utilities for basketball-reference pages
# ABOUTME: Provides configurable HTTP session injection — no built-in transport logic
