# ABOUTME: Conference and Conferences classes for parsing NCAAB conference membership.
...
class Conference:
    ...
    def _pull_conference_page(self, conference_abbreviation, year):
        ...
        # utils.check_limit()
        try:
            return pq(utils.request_through_api_gateway(CONFERENCE_URL % (conference_abbreviation, year)))
        except HTTPError:
            return None
...
class Conferences:
    ...
    def _pull_conference_page(self, year):
        ...
        # utils.check_limit()
        try:
            return pq(utils.request_through_api_gateway(CONFERENCES_URL % year))
        except HTTPError:
            return None
