# ABOUTME: Team and Teams classes for NCAAB season-level statistics.
    ...
    def _parse_team_data(self, team_data):
        ...
        for field in self.__dict__:
            ...
            value = utils._parse_field(PARSING_SCHEME,
                                       ...
                                       str(field)[1:])
            if field == '_abbreviation':
                print(":::inside abbreviation")
                print(value)
                value = value.split('/')[0]                           
                print(":::value:::")
                print(value)
...
class Teams:
    ...
    def _instantiate_teams(self, team_data_dict, year):
        ...
        year : string
            A ``string`` of the requested year to pull stats from.
        """
        print(":::instantiating teams")
        print(team_data_dict)
        print(self._conferences_dict)
