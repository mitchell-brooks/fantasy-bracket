# ABOUTME: Boxscore and Boxscores classes for parsing NCAAB game box scores.
...
from pipeline.scraper.constants import AWAY, HOME
from pipeline.scraper.decorators import float_property_decorator, int_property_decorator
...
class Boxscore:
    ...
    def _retrieve_html_page(self, uri):
        ...
        try:
            # utils.check_limit()
            url_data = pq(utils.request_through_api_gateway(url))
        except HTTPError:
            return None
...
class Boxscores:
    ...
    def _get_requested_page(self, url):
        ...
        """
        # utils.check_limit()
        return pq(utils.request_through_api_gateway(url))
